    ...
    return (
        <div>
            ...
            <div className="mt-[120px] p-[16px]">
                <Card className="border-2 border-[#FFCC15] rounded-lg h-14 mb-3">
                    <CardContent className="w-full">
                        <div className="flex justify-between items-center">
                            <h3 className="text-blue-950 text-sm font-bold mt-[17px]">Buyurtma vaqti</h3>
                            <h4 className="text-blue-950 text-sm font-bold mt-[17px]">10:53</h4>
                        </div>
                    </CardContent>
                </Card>
                <div className="flex flex-col gap-y-1 mb-3">
                    <Label className="text-yellow-400 text-base font-semibold">Mijoz</Label>
                    <Input placeholder="Boshqa" className="bg-white border border-[#FFCC15] rounded-lg" />
                </div>
                <div className="flex flex-col gap-y-1 mb-3">
                    <Label className="text-yellow-400 text-base font-semibold">Telefon</Label>
                    <Input placeholder="998991234567" className="bg-white border border-[#FFCC15] rounded-lg" type="number" />
                </div>
                <div className="flex flex-col gap-y-1 mb-3">
                    <Label className="text-yellow-400 text-base font-semibold">Manzili</Label>
                    <Input placeholder="Begoyim" className="bg-white border border-[#FFCC15] rounded-lg" type="text" />
                </div>
                <div className="flex flex-col gap-y-1 mb-3">
                    <Label className="text-yellow-400 text-base font-semibold">Izoh</Label>
                    <Input placeholder="Izoh qoldiring" className="bg-white border border-[#FFCC15] rounded-lg" type="text" />
                </div>
